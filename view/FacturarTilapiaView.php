...
<html lang="es">
  ...
  <link rel="stylesheet" href="view/bootstrap/otros/portafolio/portafolio.css">	     
         ...
         <section class="content">
          <div class="box box-primary">
			...
			<div id="detalle_registrados"></div>
          	   ...
          	   <div class="alert alert-warning" role="alert">Recuerde que estos productos se entregarán solo los MARTES Y VIERNES de cada semana.</div>
        ...
        <script type="text/javascript">
        	   ...
        	   function load_productos(pagina){
        		    ...
        		    $.ajax({
        		            ...
        		            type: 'POST',
        		            data: {action:'ajax', page:pagina, id_tipo_productos:4},
        		            success: function(x){
        	   	...
        	   	$.ajax({
        	       	...
        	       	dataType:'json'
        	       			...
        	       			swal( {
          						 ...
          						 text: "Producto agregado en el detalle correctamente",
          						 icon: "success"
          						})
        	   ...
        	   function eliminar_temporal(id)
        	   {
        	   	...
        	   	$.ajax({
        	   	 ...
        	   	 beforeSend:function(){
	       			...
	       			swal( {
  						 title:"Detalle Productos",
  						 text: "Producto eliminado del detalle correctamente",
  						 icon: "success"
  						})
