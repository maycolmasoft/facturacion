...
$image = "";
$conn  = pg_connect("user=postgres port=5432 password=Capremci2018 dbname=facturacion host=192.168.1.128");
if(!$conn)
{
...
else 
{
		...
		if (!empty($res))
		{
				...
				{
					$archivo=$_SERVER['DOCUMENT_ROOT'].'/facturacion/view/images/'.'nodisponible.jpg';
