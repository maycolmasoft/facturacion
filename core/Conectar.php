...
class Conectar{
    ...
    public function conexion(){
        ...
        if($this->driver=="pgsql" || $this->driver==null){
        	...
        	$con = pg_connect("host=192.168.1.128 port=5432 dbname=facturacion user=postgres password=Capremci2018");
        	if(!$con){
    ...
    public function startFluent(){
        ...
        if($this->driver=="pgsql" || $this->driver==null){
        	...
        	try
        	{
        		$pdo = new PDO('pgsql:host=192.168.1.128;port=5432;dbname=facturacion', 'postgres', 'Capremci2018' );
